def get_xfails(parameterization):
    reasons = {
        ...
        "double,logistic,embedding-lstm,max": "incompatible methods",
        "double,lstm-base,doc2vec,max": "incompatible methods",
        "double,lstm-base,embedding-idf,max": "incompatible methods + issue #34",
        ...
        "double,lstm-pool,embedding-idf,max": "incompatible methods + issue #34",
        ...
        "double,rf,embedding-lstm,max": "incompatible methods",
        "double,svm,doc2vec,max": "tbd",
        "double,svm,embedding-idf,max": "issue #34",
        "double,svm,embedding-lstm,max": "incompatible methods",
    }
